...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
  <tr>
    <td align="left"><h4><xsl:value-of select="jcsc/overview/rules"/></h4></td>
...
<div align="center"> 
<body>
(c) 1999-2003 by Ralph Jocham (<a href="mailto:rjocham72@netscape.net">rjocham72@netscape.net</a>)<br></br><a href="http://jcsc.sourceforge.net">JCSC</a> is released under the terms of the <a href="http://www.gnu.org/copyleft/gpl.html">GNU General Public License</a>
</body>
</div>
