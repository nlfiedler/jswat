 ...
 *
 * $Id: threadTest.java 14 2007-06-02 23:50:55Z nfiedler $
 *
 ********************************************************************/
...
/**
 * Tests the thread command.
 */
public class threadTest extends CommandTestCase {
    ...
    public static Test suite() {
        return new SessionSetup(new TestSuite(threadTest.class));
    }
    ...
    public void test_thread() {
        ...
        try {
            runCommand(session, "thread no_thread");
            fail("expected CommandException");
        } catch (CommandException ce) {
            // expected
        }

        runCommand(session, "thread");
