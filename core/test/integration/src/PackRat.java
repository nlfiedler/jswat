 ...
 *
 * $Id: PackRat.java 6 2007-05-16 07:14:24Z nfiedler $
 */
...
public class PackRat {
    ...
    private static Class static_Class;
    // instance members
    ...
    private final int INST_CONST_INT;
    private Point inst_Point;

    static {
        // Static initializer, for testing method nodes of Classes view
        static_char_array = new char[] { 'a', 'b', 'c', '1', '2', '3' };
        static_strarr = new String[] { "abc", "123", "!@#" };
        static_Class = PackRat.class;
    }

    {
        // Instance initializer, for testing method nodes of Classes view
        INST_CONST_INT = 10;
    }

    public PackRat() {
        // Constructor for testing Classes view, breakpoint setting.
        inst_Point = null;
    }

    protected PackRat(List<String> list) {
        // For testing smart breakpoint settings.
        inst_String = null;
    }
    ...
    private void primitives() {
        ...
        Byte byt = new Byte((byte) 123);
        Character chr = new Character('a');
        Double dbl = new Double(1.234d);
        Float flt = new Float(5.678f);
        Integer it = new Integer(1973);
        Long lng = new Long(5131973l);
        Short sht = new Short((short) 321);
        System.out.println("" + bool + byt + chr + dbl + flt + it + lng + sht);
    }
    ...
    private static void static_test0() {
