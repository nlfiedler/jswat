 ...
 *
 * $Id: BeepMonitorBeanInfo.java 15 2007-06-03 00:01:17Z nfiedler $
 */
...
/**
 * BeanInfo for the BeepMonitor class.
 *
 * @author Nathan Fiedler
 */
public class BeepMonitorBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        beanDescriptor = new BeanDescriptor(BeepMonitor.class);
...
//GEN-LAST:Superclass
    ...
    private static class Persistent extends DefaultPersistenceDelegate {
        ...
        /**
         * Invoke the factory method to get the BeepMonitor instance.
         * 
        ...
        protected Expression instantiate(Object oldInstance, Encoder out) {
            return new Expression(oldInstance, BeepMonitor.class,
