...
/**
 * Class BreakpointEventMulticaster implements a thread-safe list of breakpoint
...
public class BreakpointEventMulticaster implements BreakpointListener {
     ...
     */
    private final Set<BreakpointListener> listeners;

    /**
     * Creates a new instance of BreakpointEventMulticaster.
     */
    public BreakpointEventMulticaster() {
        ...
        listeners = new CopyOnWriteArraySet<BreakpointListener>();
    }
     ...
     */
    public void add(BreakpointListener l) {
        if (l != null) {
            listeners.add(l);
        }
    }
     ...
     * @param l a breakpoint listener.
     */
    public void remove(BreakpointListener l) {
        if (l != null) {
            listeners.remove(l);
        }
    }
    ...
    public void breakpointAdded(BreakpointEvent e) {
        for (BreakpointListener l : listeners) {
            l.breakpointAdded(e);
        }
    }
