 ...
 *
 * $Id: StackTraceMonitorBeanInfo.java 15 2007-06-03 00:01:17Z nfiedler $
 */
...
/**
 * BeanInfo for the StackTraceMonitor class.
 *
 * @author Nathan Fiedler
 */
public class StackTraceMonitorBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        beanDescriptor = new BeanDescriptor(StackTraceMonitor.class);
...
//GEN-LAST:Superclass
    ...
    private static class Persistent extends DefaultPersistenceDelegate {
        ...
        /**
         * Invoke the factory method to get the StackTraceMonitor instance.
         * 
        ...
        protected Expression instantiate(Object oldInstance, Encoder out) {
            return new Expression(oldInstance, StackTraceMonitor.class,
                    "getInstance", new Object[]{} );
        }
    }
}
