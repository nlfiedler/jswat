 ...
 *
 * $Id: DefaultBreakpointGroupBeanInfo.java 15 2007-06-03 00:01:17Z nfiedler $
 */
...
/**
 * BeanInfo for the DefaultBreakpointGroup.
 *
 * @author Nathan Fiedler
 */
public class DefaultBreakpointGroupBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        beanDescriptor = new BeanDescriptor(DefaultBreakpointGroup.class);
...
//GEN-LAST:Superclass
    ...
    private static class Persistent extends DefaultPersistenceDelegate {
        ...
        protected void initialize(Class<?> type, Object oldInstance,
            ...
            BreakpointGroup group = (BreakpointGroup) oldInstance;

            // It seems that writing out the groups first produces better
            // results than writing the breakpoints first.
            Iterator<BreakpointGroup> giter = group.groups(false);
            while (giter.hasNext()) {
                BreakpointGroup bg = giter.next();
                Statement st = new Statement(
                        oldInstance, "addBreakpointGroup", new Object[]{ bg });
            ...
            while (biter.hasNext()) {
                ...
                Statement st = new Statement(
                        oldInstance, "addBreakpoint", new Object[]{ bp });
                out.writeStatement(st);
            }
        }
    }
