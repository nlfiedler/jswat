 ...
 *
 * $Id: MinusBinaryOperatorNode.java 15 2007-06-03 00:01:17Z nfiedler $
 */
...
/**
 * Class MinusBinaryOperatorNode implements the subtraction binary
 * operator (-).
 *
 * @author  Nathan Fiedler
 */
class MinusBinaryOperatorNode extends BinaryOperatorNode {

    /**
     * Constructs a MinusBinaryOperatorNode.
     *
     * @param  node  lexical token.
     */
    public MinusBinaryOperatorNode(Token node) {
        super(node);
