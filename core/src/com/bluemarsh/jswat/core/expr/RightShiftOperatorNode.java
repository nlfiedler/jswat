 ...
 *
 * $Id: RightShiftOperatorNode.java 15 2007-06-03 00:01:17Z nfiedler $
 */
...
/**
 * Class RightShiftOperatorNode implements the shift right operator (>>).
 *
 * @author  Nathan Fiedler
 */
class RightShiftOperatorNode extends BinaryOperatorNode {

    /**
     * Constructs a RightShiftOperatorNode.
     *
     * @param  node  lexical token.
     */
    public RightShiftOperatorNode(Token node) {
        super(node);
