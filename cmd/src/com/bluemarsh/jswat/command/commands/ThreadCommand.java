...
/**
 * Sets the current thread in the debugging context, or displays information
 * about the currently set thread.
 *
        ...
        if (arguments.hasMoreTokens()) {
            ...
            if (thread == null) {
                throw new CommandException(
                        NbBundle.getMessage(ThreadCommand.class,
            ...
            if (thread == null) {
                ...
                String desc = String.format("[%d] %s: %s", thread.uniqueID(),
                        thread.name(), Threads.threadStatus(thread));
                writer.println(desc);
            }
        }
    }
