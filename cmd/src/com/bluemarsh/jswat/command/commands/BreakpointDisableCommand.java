...
/**
 * Disables the specified breakpoints.
 *
 * @author Nathan Fiedler
 */
public class BreakpointDisableCommand extends AbstractCommand {
        ...
        if (spec.equals("all")) {
            ...
            try {
                ...
                throw new CommandException(
                        NbBundle.getMessage(BreakpointDisableCommand.class,
                        "ERR_InvalidNumber", spec), nfe);
            }
        }
        if (count > 0) {
            writer.println(NbBundle.getMessage(BreakpointDisableCommand.class,
                    "CTL_disable_Disabled", count));
        } else {
