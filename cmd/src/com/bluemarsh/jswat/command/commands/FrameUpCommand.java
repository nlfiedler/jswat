...
/**
 * Sets the current stack frame by moving up one or more frames.
 *
 * @author Nathan Fiedler
 */
public class FrameUpCommand extends AbstractCommand {
    ...
    public void perform(CommandContext context, CommandArguments arguments)
        ...
        if (arguments.hasMoreTokens()) {
            ...
            try {
                ...
                throw new CommandException(NbBundle.getMessage(
                        FrameUpCommand.class, "ERR_InvalidNumber", token));
            }
        }
        ...
        try {
            ...
            throw new CommandException(NbBundle.getMessage(
                    FrameUpCommand.class, "ERR_ThreadNotSuspended"));
        } catch (IndexOutOfBoundsException ioobe) {
            throw new CommandException(NbBundle.getMessage(
                    FrameUpCommand.class, "ERR_InvalidStackFrame"));
        }
    }
