 ...
 *
 * $Id: DefaultCommandParser.java 15 2007-06-03 00:01:17Z nfiedler $
 */
...
public class DefaultCommandParser extends AbstractCommandParser {
    ...
    public DefaultCommandParser() {
        ...
        Lookup.Template templ = new Lookup.Template(InputProcessor.class);
        ...
        templ = new Lookup.Template(Command.class);
        commandLookupResult = Lookup.getDefault().lookup(templ);
