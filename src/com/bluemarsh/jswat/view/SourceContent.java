 ...
 *
 * DESCRIPTION:
 *      This file contains the SourceContent class definition.
 *
 * $Id: SourceContent.java 629 2002-10-26 23:03:26Z nfiedler $
 *
 ********************************************************************/
...
public class SourceContent {
    ...
    public void dump(PrintStream out) {
        try {
            ...
            out.print(", ");
            out.print(getLineEndOffset(0));
            out.print(", ");
            out.println(lineEndSize[0]);
            for (int ii = 1; ii < lineCount; ii++) {
                ...
                out.print(", ");
                out.print(getLineEndOffset(ii));
                out.print(", ");
                out.println(lineEndSize[ii]);
            }
    ...
    /**
     * Get the offset of the end of the given line, not counting the
     * end-of-line characters themselves.
     *
     * @param  line  zero-based line for which to find the end.
     * @return  offset of end of line.
     * @exception  BadLocationException
     *             Thrown if line is invalid.
     */
    public int getLineRealEndOffset(int line) throws BadLocationException {
        return getLineEndOffset(line) - lineEndSize[line];
    } // getLineEndOffset
    ...
    public static char[] replaceTabs(char[] str, int tabWidth) {
        // xxx - we should be able to do this in just the drawing
        //       and size-computing methods
    ...
    public static void main(String[] args) {
        if (args.length != 1) {
            System.err.println("Usage: SourceContent <file>");
            System.exit(1);
        }
        ...
        try {
            ...
            content = caw.toCharArray();
            isr.close();
            caw.close();
        } catch (IOException ioe) {
            ioe.printStackTrace();
        }
        SourceContent sc = new SourceContent(content);
        sc.dump(System.out);
    } // main
} // SourceContent
