 ...
 *
 * $Id: stepCommand.java 14 2007-06-02 23:50:55Z nfiedler $
 *
 ********************************************************************/
...
public class stepCommand extends JSwatCommand {
    ...
    public void perform(Session session, CommandArguments args, Log out) {
        ...
        if (Stepping.step(
                session.getVM(), current, StepRequest.STEP_LINE, howmuch,
                onlyThread, session.getProperty("excludes"))) {
