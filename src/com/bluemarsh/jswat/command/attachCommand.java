 ...
 *
 * DESCRIPTION:
 *      This file defines the class that handles the 'attach' command.
 *
 * $Id: attachCommand.java 629 2002-10-26 23:03:26Z nfiedler $
 *
 ********************************************************************/
    ...
    public void perform(Session session, StringTokenizer args, Log out) {
        ...
        if (useShare) {
            ...
            try {
                ...
                out.writeln(swat.getResourceString("noShmemVMsFound"));
                return;
            }
        } else {
            ...
            try {
                ...
                out.writeln(swat.getResourceString("noSocketVMsFound"));
                return;
            }
        }
        ...
        if (connection != null) {
            ...
            if (connection.attachDebuggee(session)) {
