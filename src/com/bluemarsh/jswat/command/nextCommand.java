 ...
 *
 * DESCRIPTION:
 *      This file defines the class that handles the 'next' command.
 *
 * $Id: nextCommand.java 629 2002-10-26 23:03:26Z nfiedler $
 *
 ********************************************************************/
 ...
 * @author  Nathan Fiedler
 */
public class nextCommand extends stepCommand {
	...
	if (!session.isActive()) {
        ...
        step(session, args, out, StepRequest.STEP_LINE, StepRequest.STEP_OVER);
    } // perform
} // nextCommand
