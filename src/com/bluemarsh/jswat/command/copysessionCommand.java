 ...
 *
 * $Id: copysessionCommand.java 14 2007-06-02 23:50:55Z nfiedler $
 *
 ********************************************************************/
...
/**
 * Defines the class that handles the 'copysession' command.
 *
 * @author  Nathan Fiedler
 */
public class copysessionCommand extends JSwatCommand {

    /**
     * Perform the 'copysession' command.
     *
    ...
    public void perform(Session session, CommandArguments args, Log out) {
        if (args.hasMoreTokens()) {
            try {
                SessionSettings.copySettings(args.nextToken());
