 ...
 *
 * DESCRIPTION:
 *      This file defines the class that handles the 'nexti' command.
 *
 * $Id: nextiCommand.java 629 2002-10-26 23:03:26Z nfiedler $
 *
 ********************************************************************/
 ...
 * @author  Nathan Fiedler
 */
public class nextiCommand extends stepCommand {
	...
	if (!session.isActive()) {
        ...
        step(session, args, out, StepRequest.STEP_MIN, StepRequest.STEP_OVER);
    } // perform
} // nextiCommand
