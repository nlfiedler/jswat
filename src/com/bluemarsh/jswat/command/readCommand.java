 ...
 *      nf      09/03/01        Improved missing args messsage
 *
 * DESCRIPTION:
 *      This file defines the class that handles the 'read' command.
 *
 * $Id: readCommand.java 629 2002-10-26 23:03:26Z nfiedler $
 *
 ********************************************************************/
 ...
 * @author  Nathan Fiedler
 */
public class readCommand extends JSwatCommand {
    ...
    public void perform(Session session, StringTokenizer args, Log out) {
        ...
        cmdman.runScript(args.restTrim());
    } // perform
} // readCommand
