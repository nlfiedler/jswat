 ...
 *
 * DESCRIPTION:
 *      This file defines the class that handles the 'disablegc' command.
 *
 * $Id: disablegcCommand.java 629 2002-10-26 23:03:26Z nfiedler $
 *
 ********************************************************************/
 ...
 * @author  Nathan Fiedler
 */
public class disablegcCommand extends JSwatCommand {
    ...
    public void perform(Session session, StringTokenizer args, Log out) {
        ...
        try {
            ...
            if (val instanceof ObjectReference) {
                ...
                out.writeln(swat.getResourceString("collectionDisabled"));
            } else {
