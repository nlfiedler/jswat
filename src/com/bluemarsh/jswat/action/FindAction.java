 ...
 *
 * $Id: FindAction.java 1814 2005-07-17 05:56:32Z nfiedler $
 *
 ********************************************************************/
...
public class FindAction extends JSwatAction {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        JSwatView view = adapter.getSelectedView();
        ...
        String query = session.getProperty("searchString");
        if (query == null) {
            query = "";
        }
        String ignoreCaseStr = session.getProperty("searchIgnoreCase");
        boolean ignoreCase = false;
	if ((ignoreCaseStr != null) &&
            ignoreCaseStr.equalsIgnoreCase("true")) {
            ignoreCase = true;
        }
        ...
        Object messages[] = {
            ...
            new JCheckBox(Bundle.getString("Find.ignoreCase"),
                          ignoreCase)
        };

        int response = JOptionPane.showOptionDialog
            (frame, messages, Bundle.getString("Find.title"),
        ...
        if (response == JOptionPane.OK_OPTION) {
            ...
            // Save the string value as a session property so the
            // FindAgain action can use it to find the next occurance.
            session.setProperty("searchString", query);
            session.setProperty("searchIgnoreCase",
