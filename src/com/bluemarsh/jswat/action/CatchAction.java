 ...
 *
 * $Id: CatchAction.java 1814 2005-07-17 05:56:32Z nfiedler $
 *
 ********************************************************************/
...
public class CatchAction extends JSwatAction {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        while (!responseOkay) {
            ...
            if (className.length() == 0) {
                JOptionPane.showMessageDialog(
                    ...
                    Bundle.getString("Catch.errorTitle"),
        ...
        try {
            brkman.createExceptionCatch(className);
            session.getStatusLog().writeln(Bundle.getString("Catch.added"));
