 ...
 *
 * $Id: VMAttachAction.java 1814 2005-07-17 05:56:32Z nfiedler $
 *
 ********************************************************************/
...
public class VMAttachAction extends JSwatAction {
     ...
     */
    protected class AttachDialog extends JDialog implements ActionListener, ItemListener {
        /** silence the compiler warnings */
        private static final long serialVersionUID = 1L;
        /** Text field for host name. */
        protected JTextField hostNameField;
        /** Text field for port number. */
        protected JTextField portNumberField;
        /** Text field for share name. */
        protected JTextField shareNameField;
        ...
        public AttachDialog(Frame owner, Session session) {
            ...
            useShared = Boolean.valueOf(useShmem).booleanValue();
        ...
        protected boolean attachShmem() {
            ...
            try {
                ...
                displayError(win, swat.getResourceString(
                    "noShmemVMsFound"));
                return false;
            }
            ...
            if (connection != null) {
                ...
                try {
                    connection.attachDebuggee(session);
                } finally {
            ...
            session.setProperty("useShmem", "true");
            return true;
        } // attachShmem
        ...
        protected boolean attachSocket() {
            ...
            session.setProperty("useShmem", "false");
            return true;
        } // attachSocket
        ...
        protected JPanel buildShmemPanel(Session session) {
            ...
            example = new JLabel(Bundle.getString("Attach.shmemExample"));
        ...
        protected JPanel buildSocketPanel(Session session) {
            ...
            example = new JLabel(Bundle.getString("Attach.socketExample"));
            example.setFont(new Font("Monospaced", Font.PLAIN, 12));
            gbl.setConstraints(example, gbc);
            allPanel.add(example);
