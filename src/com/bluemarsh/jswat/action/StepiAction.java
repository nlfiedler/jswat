 ...
 *
 * $Id: StepiAction.java 1814 2005-07-17 05:56:32Z nfiedler $
 *
 ********************************************************************/
 ...
 */
public class StepiAction extends StepAction {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (session.isActive()) {
            ...
            step(session, StepRequest.STEP_MIN, StepRequest.STEP_INTO);
        } else {
