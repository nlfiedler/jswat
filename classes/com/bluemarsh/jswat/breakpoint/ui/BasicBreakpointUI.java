 ...
 *
 * $Id: BasicBreakpointUI.java 14 2007-06-02 23:50:55Z nfiedler $
 *
 ********************************************************************/
...
public class BasicBreakpointUI implements BreakpointUI {
    ...
    public BasicBreakpointUI(Breakpoint bp) {
        ...
        // Inidicate the resolution status of the breakpoint.
        JLabel label = new JLabel(bp.isResolved()
            ? Bundle.getString("resolvedLabel")
            : Bundle.getString("unresolvedLabel"));
        ...
        label = new JLabel(Bundle.getString("suspendPolicyLabel"));
        ...
        if (bp instanceof LocatableBreakpoint) {
            // If the breakpoint is locatable, it may have a class name.
            ...
            JTextField tf = new JTextField(lbp.getClassName(), 20);
    ...
    protected class NumericDocument extends PlainDocument {
         ...
         *          if insertion offset is illegal.
         */
