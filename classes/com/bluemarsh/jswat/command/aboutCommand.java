 ...
 *
 * DESCRIPTION:
 *      This file defines the class that handles the 'about' command.
 *
 * $Id: aboutCommand.java 14 2007-06-02 23:50:55Z nfiedler $
 *
 ********************************************************************/
 ...
 * @author  Nathan Fiedler
 */
public class aboutCommand extends JSwatCommand {
    ...
    public void perform(Session session, CommandArguments args, Log out) {
        String ver = AppVersion.getVersion();
        out.writeln("JSwat " + ver + '\n' +
                    com.bluemarsh.jswat.Bundle.getString("about1") + '\n' +
                    com.bluemarsh.jswat.Bundle.getString("about2") + '\n' +
                    com.bluemarsh.jswat.Bundle.getString("about3"));
    } // perform
} // aboutCommand
