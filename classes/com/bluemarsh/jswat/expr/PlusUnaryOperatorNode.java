 ...
 *
 * $Id: PlusUnaryOperatorNode.java 14 2007-06-02 23:50:55Z nfiedler $
 *
 ********************************************************************/
...
/**
 * Class PlusUnaryOperatorNode implements the plus unary operator (+).
 *
 * @author  Nathan Fiedler
 */
class PlusUnaryOperatorNode extends UnaryOperatorNode {

    /**
     * Constructs a PlusUnaryOperatorNode.
     *
     * @param  node  lexical token.
     */
    public PlusUnaryOperatorNode(Token node) {
        super(node);
    } // PlusUnaryOperatorNode
