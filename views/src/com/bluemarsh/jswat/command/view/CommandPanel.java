...
public class CommandPanel extends JPanel implements Runnable {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("com/bluemarsh/jswat/command/view/Form"); // NOI18N
        inputLabel.setText(bundle.getString("LBL_Command_Input")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
