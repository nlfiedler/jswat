...
import com.bluemarsh.jswat.command.commands.FrameJumpCommand;

/**
 * Extends the "frame" command to issue a 1-frame stack trace. <p>
 *
 * @see UpCommand
 * @author Steve Yegge
 */
public class FrameCommand extends FrameJumpCommand {
