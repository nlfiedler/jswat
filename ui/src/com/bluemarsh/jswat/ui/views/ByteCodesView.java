 ...
 *
 * $Id: ByteCodesView.java 15 2007-06-03 00:01:17Z nfiedler $
 */
...
//                });
	...
	public ByteCodesEditorKit() {
        ...
        /**
         * Creates the default document for this editor kit.
         *
    ...
    private static class ByteCodesDocument extends NbEditorDocument
        ...
        /**
         * Create the toolbar for the given editor pane.
         *
         * @param  pane  editor pane for which to create toolbar.
